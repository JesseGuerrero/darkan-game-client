...
public class InteractableObject extends GraphNode_Sub1_Sub1 implements WorldObject {
    ...
    public static void method16099(IComponentDefinitions[] interfaceComps, int i_1, int width, int height, boolean bool_4) {
        for (int i_6 = 0; i_6 < interfaceComps.length; i_6++) {
            IComponentDefinitions icomponentdefinitions_7 = interfaceComps[i_6];
    ...
    /*
    * Custom overload to test interfaces by ID for further customization
    * You can find the interface by printing them higher in the method stack then hiding components here
    * from more specific ones
    * */
    public static void method16099(IComponentDefinitions[] interfaceComps, int emptyValue, int width, int height, boolean bool_4, int interID) {
...
//            if(interID == 744) { continue; }
            ...
            if(interID == 667 || interID == 744) {
            }
            IComponentDefinitions component = interfaceComps[i];
                if (component != null && component.parent == emptyValue) {
