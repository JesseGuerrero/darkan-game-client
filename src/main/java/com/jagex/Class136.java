...
public class Class136 {
    ...
    Class136(OpenGLRenderer class505_sub1_1) {
        ...
        if (!aBool1631) {
            ...
            byte[] bytes_5 = QuickChatMessage.castScriptArchive(anObject1637, false);
            ...
            bytes_5 = QuickChatMessage.castScriptArchive(anObject1627, false);
            ...
            if (class164_6.method2847()) {
                bytes_5 = QuickChatMessage.castScriptArchive(anObject1628, false);
