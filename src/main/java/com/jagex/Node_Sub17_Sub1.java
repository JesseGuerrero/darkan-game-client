...
public class Node_Sub17_Sub1 extends Node_Sub17 {
    ...
    public static void method15402(int renderType, String tooltipText, boolean bool_2) {
        if (renderType == 0) {
            ...
            if (tooltipText != null) {
                ...
                Class446.method7447(tooltipText, true, Renderers.CURRENT_RENDERER, fontrenderer_5, fontmetrics_4);
            }
        } else {
            ...
            if (tooltipText != null) {
                ...
                EntityNode.method4891();
                Class446.method7447(tooltipText, true, graphicalrenderer_16, fontrenderer_6, fontmetrics_17);
            }
            try {
                try {
                    ...
                    if (Renderers.CURRENT_RENDERER.method8399()) {
                        boolean enoughRAM = true;
                        try {
                            enoughRAM = Class11.SYSTEM_INFO.ram > 256;
                    ...
                    method15402(i_9, tooltipText, bool_2);
