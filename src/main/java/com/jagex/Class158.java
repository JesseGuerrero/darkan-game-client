...
public abstract class Class158 {
    ...
    static void method2731(AbstractRenderer currentRenderer, Class455 class455_1, IComponentDefinitions component, int drawX, int drawY, int i_5, int i_6, int areaID) {
        MapAreaDefinitions worldmapareadefs_9 = IndexLoaders.WORLD_MAP_LOADER.getWorldMapDefs(areaID);
        if (worldmapareadefs_9 != null && worldmapareadefs_9.aBool2729 && worldmapareadefs_9.shouldDraw(Class158_Sub1.PLAYER_VAR_PROVIDER)) {
            ...
            if (worldmapareadefs_9.anIntArray2717 != null) {
                ...
                for (i_11 = 0; i_11 < ints_10.length / 2; i_11++) {
                    ...
                    ints_10[i_11 * 2] = drawX + component.width / 2 + ((worldmapareadefs_9.anIntArray2717[i_11 * 2 + 1] * 4 + i_6) * i_13 + i_14 * (i_5 + worldmapareadefs_9.anIntArray2717[i_11 * 2] * 4) >> 14);
                    ints_10[i_11 * 2 + 1] = component.height / 2 + drawY - ((worldmapareadefs_9.anIntArray2717[i_11 * 2 + 1] * 4 + i_6) * i_14 - i_13 * (i_5 + worldmapareadefs_9.anIntArray2717[i_11 * 2] * 4) >> 14);
                }
                Class119 class119_19 = component.method2046(currentRenderer);
                if (class119_19 != null) {
                    Class147.method2505(currentRenderer, ints_10, worldmapareadefs_9.anInt2715, class119_19.anIntArray1457, class119_19.anIntArray1455);
                }
                if (worldmapareadefs_9.anInt2748 > 0) {
                    ...
                    for (i_12 = 0; i_12 < ints_10.length / 2 - 1; i_12++) {
                        ...
                        currentRenderer.method8563(i_13, i_14, i_15, i_16, worldmapareadefs_9.anIntArray2738[worldmapareadefs_9.aByteArray2754[i_12] & 0xff], class455_1, drawX, drawY, worldmapareadefs_9.anInt2748, worldmapareadefs_9.anInt2749, worldmapareadefs_9.anInt2756);
                    }
                    ...
                    currentRenderer.method8563(i_12, i_13, i_14, i_15, worldmapareadefs_9.anIntArray2738[worldmapareadefs_9.aByteArray2754[worldmapareadefs_9.aByteArray2754.length - 1] & 0xff], class455_1, drawX, drawY, worldmapareadefs_9.anInt2748, worldmapareadefs_9.anInt2749, worldmapareadefs_9.anInt2756);
                } else {
                    for (i_12 = 0; i_12 < ints_10.length / 2 - 1; i_12++) {
                        currentRenderer.method8669(ints_10[i_12 * 2], ints_10[i_12 * 2 + 1], ints_10[(i_12 + 1) * 2], ints_10[(i_12 + 1) * 2 + 1], worldmapareadefs_9.anIntArray2738[worldmapareadefs_9.aByteArray2754[i_12] & 0xff], class455_1, drawX, drawY);
                    }
                    currentRenderer.method8669(ints_10[ints_10.length - 2], ints_10[ints_10.length - 1], ints_10[0], ints_10[1], worldmapareadefs_9.anIntArray2738[worldmapareadefs_9.aByteArray2754[worldmapareadefs_9.aByteArray2754.length - 1] & 0xff], class455_1, drawX, drawY);
                }
            }
            NativeSprite nativesprite_22 = null;
            if (worldmapareadefs_9.anInt2719 != -1) {
                nativesprite_22 = worldmapareadefs_9.renderIcons(currentRenderer, false);
                if (nativesprite_22 != null) {
                    Class190.method3149(component, class455_1, drawX, drawY, i_5, i_6, nativesprite_22);
                }
            }
            if (worldmapareadefs_9.areaName != null) {
                ...
                Class241.method4152(component, class455_1, drawX, drawY, i_5, i_6, i_11, worldmapareadefs_9.areaName, fontrenderer_20, fontmetrics_21, worldmapareadefs_9.anInt2720);
            }
        }
    }
